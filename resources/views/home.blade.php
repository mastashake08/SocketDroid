...
for (var i = 0; i < pushes.length; i++) {
    pushes[i].addEventListener('click', function(){
      $.post("https://socketdroid.com/send-push/" + $(this).data('id'),{title:document.getElementsByClassName("action-push-title")[i-1].value,message:document.getElementsByClassName("action-push-text")[i-1].value}, function(data, status){
